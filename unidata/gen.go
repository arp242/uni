...
func mkemojis() error {
	...
	fp.WriteString("// Code generated by gen.go; DO NOT EDIT\n\n" +
		"package unidata\n\n")
	...
	fp.WriteString("var Emojis = []Emoji{\n")
	for _, k := range order {
		e := emojis[k]
		fp.WriteString(fmt.Sprintf("\t{[]uint32{%s}, `%s`, `%s`, `%s`, %s, %s},\n",
...
func mkcodepoints() error {
	...
	for _, line := range bytes.Split(text, []byte("\n")) {
		...
		fp.WriteString(fmt.Sprintf("\t\"%s\": {%d, %d, 0x%x, \"%s\"},\n",
