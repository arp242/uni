...
var Properties = map[Property]struct {
	...
	PropIDSUnaryOperator: {"IDS Unary Operator", [][2]rune{
		{0x2FFE, 0x2FFF},
	}},
	PropIDCompatMathContinue: {"ID Compat Math Continue", [][2]rune{
		{0x1D7C3, 0x1D7C3},
		{0x1D7A9, 0x1D7A9},
		{0x1D789, 0x1D789},
		{0x1D76F, 0x1D76F},
	...
	PropIDCompatMathStart: {"ID Compat Math Start", [][2]rune{
		{0x1D7C3, 0x1D7C3},
		{0x1D7A9, 0x1D7A9},
		{0x1D789, 0x1D789},
		{0x1D76F, 0x1D76F},
	...
	PropModifierCombiningMark: {"Modifier Combining Mark", [][2]rune{
		{0x08F3, 0x08F3},
		{0x08D3, 0x08D3},
		{0x08CD, 0x08CF},
		{0x08CA, 0x08CB},
